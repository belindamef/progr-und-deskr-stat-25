...
\begin{enumerate}
  ...
  \item Überlege euch zu den gelernten Konzepten eigene Beispiele und dokumentiert diese im R Skript aus SKF 1.
  ...
  \item Erläutere Sie, was im Zusammenhang mit der Indizierung in R mit "zu hoher Flexibilität" gemeint ist.
\end{enumerate}
