...
\item Schreibe ein einfaches Skript, in welchem Daten in ein Dataframe eingelesen werden, neue Daten hinzugefügt und das neue Dataframe in einer neuen Datei gespeichert wird.
\item Schreibe den gleichen Code nun für einen geänderte Pfadvariabel um.
  \begin{itemize} \small
  ...
  \item Nehme die jetzt notwendige Anpassung ind er Pfadvariable vor, die du zum Einlesen der Daten verwendest.
  \item Beachte, dass sich dabei in deiner Ordner-Struktur auf der Festplatte \textit{nichts} ändert, sondern \textit{nur} das ''Workinf Directory'' und die Pfadvariable.
  \end{itemize}
\end{enumerate}
