...
\small
\setstretch{1.8}
1. Dokumentiere alle in dieser Einheit eingeführten Befehle in einem R Skript.
2. Erzeuge in R die Matrizen
\begin{equation*}
A = 
\begin{pmatrix}
4 & 3 & 2 & 1 \\
...
\end{pmatrix}
\end{equation*}
1. Kopiere die zweite Zeile von $A$ in einen Vektor.
2. Kopiere die erste und dritte Spalte von $B$ in eine 3 $\times$ 2 Matrix.
3. Setze alle Nullen in $B$ auf -1.
4. Setze die zweite Zeile von $A$ auf $(1\,2\,3\,4)$.
5. Addiere die Matrizen $A$ und $B$.
6. Multipliziere Matrix $A$ mit 3.
7. Konkateniere die Matrizen $A$ und $B$ zeilenweise.
8. Konkatenieren die Matrizen $A$ und $B$ spaltenweise.
