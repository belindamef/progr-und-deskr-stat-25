...
\begin{enumerate}
\justifying
\item Erzeuge und visualisiere die kumulativen absoluten und relativen Häufigkeitsverteilungen der Post.BDI Daten des Beispieldatensatzes \textit{psychotherapie\_datensatz.csv}.
\item Erzeuge und visualisiere die empirische Verteilungsfunktion der Post.BDI Daten.
\item Berechne das obere Quartil des Beispieldatensatzes auf Folie 16.
\item Berechne das untere Quartil, den Median und das obere Quartil der Post.BDI Daten. Vergleiche deine Ergebnisse mit der Ausgabe der \texttt{summary()} Funktion.
\item Erstelle einen Boxplot der Post.BDI Daten.
\end{enumerate}
...
\item Definiere die Begriffe unteres Quartil, Median und oberes Quartil mithilfe des $p$-Quantils.
\end{enumerate}
