...
![](../Abbildungen/pds_7_plot_viewer_base.png){width="70%" fig-align="center"}
...
Das R-Paket \textcolor{linkblue}{\href{https://github.com/REditorSupport/vscode-R/wiki/Plot-viewer}{httpgd}} vereinfacht die Arbeit mit Grafiken in VS Code.

![](../Abbildungen/pds_7_plot_viewer.png){width="70%" fig-align="center"}

\setstretch{1.2}


\begin{itemize}
\item Nach der Installation des Pakets kann der Plot Viewer in den VS Code-Einstellungen über die Option \textbf{r.plot.useHttpgd} aktiviert werden.
...
\item Visualisiere die Häufigkeitsverteilungen der Differenzen zwischen Post- und Pre-BDI-Daten getrennt nach den experimentellen Bedingungen (\textquote{Klassisch} und \textquote{Online}). Nutze dein Wissen zu Indizierung in R, um die Daten korrekt zu filtern, und beschrifte die Diagramme entsprechend.
