...
\vspace{3mm}
\center
![](../VL_Abbildungen/pds_1_mikro.png){width="8%"}
...
![](../VL_Abbildungen/magl_0_homepage.png){width="80%"}
...
\textcolor{darkblue}{Seminar und Präsenzübung}

\begin{itemize}  \justifying 
\item Theoretische und praktische Einführung in die wesentlichen Konzepte der Programmierung und deskriptiven Statistik.
\item Anwendung der erlernten Konzepte in praktischen Übungen, unterstützt durch Hilfestellung von Lehrpersonen und Tutor:innen während der Präsenzübungen.
\end{itemize}

\textcolor{darkblue}{Programmierübungen}

\begin{itemize}  \justifying 
\item Neben den Präsenzzeiten werden wöchentliche Vor- und Nachbereitung der Programmierübungen und Selbstkontrollfragen dringend empfohlen!
\item Die Computerplätze am URZ sind außerhalb der Belegzeiten (siehe \textcolor{linkblue}{\href{https://lsf.ovgu.de/qislsf/rds?state=wplan&act=Raum&pool=Raum&show=plan&P.vx=mittel&raum.rgid=176}{G26.1-006}} oder \textcolor{linkblue}{\href{https://lsf.ovgu.de/qislsf/rds?state=wplan&act=Raum&pool=Raum&show=plan&P.vx=mittel&raum.rgid=177}{G26.1 007}}) öffentlich zugänglich. 
\end{itemize}
...
* Kursmaterialien (Folien, Videos) auf der \textcolor{linkblue}{\href{https://www.ipsy.ovgu.de/Institut/Abteilungen+des+Institutes/Methodenlehre+I+_+Experimentelle+und+Neurowissenschaftliche+Psychologie/Lehre/Wintersemester+2025/Programmierung+und+Deskriptive+Statistik.html}{Kurswebseite}}
* Codes und tagesakutelle Folien auf \textcolor{linkblue}{\href{https://github.com/belindamef/progr-und-deskr-stat-25}{GitHub}}
* Vorherige Iteration des Kurses: \textcolor{linkblue}{\href{https://www.ipsy.ovgu.de/Institut/Abteilungen+des+Institutes/Methodenlehre+I+_+Experimentelle+und+Neurowissenschaftliche+Psychologie/Lehre/Wintersemester+2024/Programmierung+und+Deskriptive+Statistik.html}{PDS (WS 2023/24)}}
* Empfohlene Vorbereitung: \textcolor{linkblue}{\href{https://www.ipsy.ovgu.de/Institut/Abteilungen+des+Institutes/Methodenlehre+I+_+Experimentelle+und+Neurowissenschaftliche+Psychologie/Lehre/Wintersemester+2025/Mathematische+Grundlagen.html}{Vorkurs ''Mathematische Grundlagen''}}
* Ankündigungen und Fragen-Forum im \textcolor{linkblue}{\href{https://mm.cs.ovgu.de/bsc-psychologie-2023/channels/c1---programmierung-und-deskriptive-statistik-wise-20242025}{Mattermost-Channel}}
* Abgabe und Evaluation des Leistungsnachweises über den \textcolor{linkblue}{\href{https://elearning.ovgu.de/course/view.php?id=17237}{Moodlekurs}}
...
[\textcolor{linkblue}{Webseite des Kurses (Folien, Videos)}](https://www.ipsy.ovgu.de/Institut/Abteilungen+des+Institutes/Methodenlehre+I+_+Experimentelle+und+Neurowissenschaftliche+Psychologie/Lehre/Wintersemester+2025/Programmierung+und+Deskriptive+Statistik.html)

![](../VL_Abbildungen/pds_1_kurswebsite_2024.png){width="80%"}
...
* Beitritt zum **Channel** [\textcolor{linkblue}{C1 - Programmierung und Deskriptive Statistik (WiSe 2024/2025)
}](https://mm.cs.ovgu.de/bsc-psychologie-2023/channels/c1---programmierung-und-deskriptive-statistik-wise-20242025)
...
![](../VL_Abbildungen/migl_7_datenwissenschaft.pdf){width="85%" fig-align="center"}
...
![](../VL_Abbildungen/pds_1_PYPL_index_2024.png){width="60%" fig-align="left"}
...
![](../VL_Abbildungen/migl_7_informatik.pdf){width="85%" fig-align="center"}
...
![](../VL_Abbildungen/migl_7_hardware.pdf){width="60%" fig-align="center"}
...
![*Hattenhauer (2020) Informatik*](../VL_Abbildungen/migl_7_zentraleinheit.pdf){width="50%" fig-align="center"}
...
\center
\textbf{ $\to$ Die Architektur eines Rechners impliziert das Grundprinzip der Programmierung: \\
...
![](../VL_Abbildungen/migl_7_programmiersprache.pdf){width="50%" fig-align="center"}
...
![](../VL_Abbildungen/migl_7_algorithmen_und_programme.pdf){width="80%" fig-align="center"}
...
* Seit 2018 ist VSCode der beliebteste Editor laut jährlicher [\textcolor{linkblue}{stackoverflow Umfragen}](https://survey.stackoverflow.co/2024/technology#2-integrated-development-environment).
...
![](../VL_Abbildungen/pds_1_VSCode.png){width="80%" fig-pos="center"}
...
![](../VL_Abbildungen/pds_1_VSCode_docs.png){width="80%" fig-pos="center"}




# Aufgaben und Selbstkontrollfragen ------------------------------------{.plain}
\AtBeginSection{}
\section{Aufgaben und Selbstkontrollfragen}
...
3. VSCode für R startklar machen (Konsultiere dafür die [\textcolor{linkblue}{Online-Doku}](https://code.visualstudio.com/docs/languages/r)).
...
5. Mit dem eigenen oder Labor-Rechner vertraut machen. \small \justifying
   ...
   - Probiere aus, mit welchen Programmen du du diese Dateien jeweils öffnen kannst und mit welchen nicht.
