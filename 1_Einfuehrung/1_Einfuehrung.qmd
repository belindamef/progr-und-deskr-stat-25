...
\item Anwendung der erlernten Konzepte in praktischen Übungen, unterstützt durch Hilfestellung von Lehrpersonen und Tutor:innen während der Praxisstunden.
\end{itemize}
...
\item Leistungsnachweis gilt als erbracht, wenn mind. 50 \% der abgegebenen Leistungen als bestanden berwertet wurden.
\end{itemize}
...
* \justifying Termine: Dienstags
  * Gruppe 1: 11-13 Uhr in \textcolor{linkblue}{\href{https://lsf.ovgu.de/qislsf/rds?state=wplan&act=Raum&pool=Raum&show=plan&P.vx=mittel&raum.rgid=177}{G26.1 007}} (Persönlicher Laptop optional)
  * Gruppe 2: 13-15 Uhr in G40B-331 (Persönlicher Laptop notwendig)
...
* Ankündigungen, Fragen-Forum im \textcolor{linkblue}{\href{https://mm.cs.ovgu.de/bsc-psychologie-2023/channels/c1---programmierung-und-deskriptive-statistik-wise-20242025}{Mattermost-Channel}}
...
17.12.24       & Deskriptive Statistik & (9) Maße der zentralen Tendenz und Variabilität & Seminar \\
  & \textcolor{gray}{Weihnachtspause}    \\
07.01.25       & R Grundlagen          & (10) Kontrollstrukturen; Datensimulationen & Seminar \\
14.01.25       &           & \hspace{4mm} Praxisseminar  & \hspace{10mm} Übung \\
21.01.25       & Deskriptive Statistik     & (11)  Anwendungsbeispiel & Seminar + Übung \\
28.01.25       & Deskriptive Statistik     & (11) Anwendungsbeispiel  & Seminar + Übung \\
\end{tabular}
...
![](../Abbildungen/pds_1_kurswebsite_2024.png){width="80%"}
...
![](../Abbildungen/pds_1_gitrepo_25.png){width="80%"}
...
![](../Abbildungen/pds_1_mattermost_24_25.png){width="80%"}

\small

* Regristierung und Beitritt zum **Team** \textcolor{linkblue}{\href{https://mm.cs.ovgu.de/signup_user_complete/?id=7bayes88j7r85mo4nidiw3z3pe&md=link&sbr=su}{MethPsy I - Studis}}.
...
![](../Abbildungen/pds_1_markdown.png){width="85%" fig-align="center"}
