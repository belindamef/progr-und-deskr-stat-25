...
* \justifying Termine: Dienstags
  ...
  * Gruppe 2: 13-15 Uhr in G22A-120 (Persönlicher Laptop notwendig)
...
07.01.25       & R; Deskriptive Statisitk & (10) Kontrollstrukturen; Anwendungsbeispiel & Seminar      \\
...
![](../Abbildungen/pds_1_Datenanalyse_skript_Schaubild.pdf){width="105%" fig-align="left"}
...
\setstretch{1.5}
\small
1.  Gebe die typische Struktur einer computergestützten Datenanalyse wieder.
2.  Erläutere den Begriff "Datenanalyseskript".
3.  Definiere den Begriff "Informatik".
4.  Erläutere Sie die Akronyme CPU, RAM, SSD, und GPU.
