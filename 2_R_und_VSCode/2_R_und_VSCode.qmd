...
# VSCode Interactive Viewers: Help Viewer


![](../Abbildungen/pds_2_R_helpviewer.png){width="75%" fig-align="center"}
...
\begin{enumerate}
\item Klickt euch durch die VSCode User Interface.
\begin{enumerate} \footnotesize
\item Welche verschwiedenen Views können in der \textit{Activity Bar} ausgewählt.
...
\item Gib unvollständige Befehl in die Console ein und drücke die \fbox{Enter}-Taste.
\end{enumerate}
