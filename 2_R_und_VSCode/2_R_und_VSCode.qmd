...
\item Gib unvollständige Befehl in die Console ein und drücke die \fbox{Enter}-Taste. \\ (Beispiele: \texttt{print("Hello"}, \texttt{sqrt(4}, \texttt{x <-}, \texttt{sqrt(1 +}). Wie kannst du den prompt '>' wiederherstellen?
\end{enumerate}
